class ScatterPlot {
    ...
    update() {
        ...
        self.cvalue = d => d.quality;
        self.xvalue = d => d.fixed_acidity;
        self.yvalue = d => d.volatile_acidity;
    ...
    render() {
        ...
        circles
            .on('mouseover', (e,d) => {
                d3.select('#tooltip')
                    .style('opacity', 1)
                    .html(`<div class="tooltip-label">${d.quality}</div>(${d.fixed_acidity}, ${d.fixed_acidity})`);
            })
            .on('mousemove', (e) => {
                const padding = 10;
                d3.select('#tooltip')
